...
Jester favours simplicity - both in programming model and operations - over raw performance. It's built for those 99% of line of business applications that don't require massive scalability. That's not to say some of the tools aren't performant, but I wouldn't try to build Twitter or Facebook using Jester alone.
